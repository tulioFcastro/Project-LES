...
public class DataBaseWrapper extends SQLiteOpenHelper {
	...
	private static final String DATABASE_NAME = "LES2.db";  // The database name 
	private static final int DATABASE_VERSION = 1;		   // Database version

	private static final String DATABASE_CREATE = "create table " + TABLE_USER	//
			+ "(" + USER_ID + " integer primary key autoincrement, " 			//  Expression for the creation of the table
			+ USER_NAME + " text not null, " + USER_EMAIL + " text not null);"; //  User.

	
	
	/** Creator of a DataBaseWrapper, it receives the current context as a parameter
	 * 
	 * @param context
	 * 		- The current context.
	 */
	 ...
	 * 
	 * @param db
	 * 		- the SQLiteDatabase where the data base will be created.
	 */
	@Override
	 ...
	 * @param oldVersion
	 * 		- Number to specify the older version of the database.
	 * @param newVersion
	 * 		- Number to specify the new version of the database.
	 */
	@Override
